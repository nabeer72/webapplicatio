    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('carousel-update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="subtitle" class="form-control border border-secondary p-2" value="{{ $model->subtitle }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="subdescription" class="form-control border border-secondary p-2" value="{{ $model->subdescription }}">
                            </div>

                            <!-- Video Link -->
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Video Link</label>
                                <input type="text" name="videolink" class="form-control border border-secondary p-2" value="{{ $model->videolink }}">
                            </div>
